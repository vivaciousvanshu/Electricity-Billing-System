...
public class Project extends JFrame implements ActionListener{
     Project()
     {
         ...
         ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("electricity/icon/icon4.png"));
         ...
         ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("electricity/icon/icon5.png"));
         Image image5 = icon5.getImage().getScaledInstance(20,20,Image.SCALE_DEFAULT);
         u2.setIcon(new ImageIcon(image2));
         u2.setMnemonic('B');
